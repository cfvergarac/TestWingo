...
${ChkTARJETACREDITO}      xpath=//div[@class='accordeon-tab-content-title'][1]        #xpath=//div[@class='accordeon-tab-content-title'][contains(.,'Tarjeta de crédito')]     #xpath=//label[@for='payment_method_2']
...
${PNRAPELLIDO}            xpath=//div[@class='col-sm-12 w-confirm-passengers-details--header']/following-sibling::div
...
Asignar elementos Pagina pagos
    ...
    ${txtCompra}=    set variable if      ${LENGUA}=='ES'         tu compra                   your purchase
    set test variable       ${txtCompra}
    ${txtConfirmacion}=     set variable if      ${LENGUA}=='ES'           xpath=(//div[@class='col-xs-7'][contains(.,'Tarifas aéreas')])[1]          xpath=(//div[@class='col-xs-7'][contains(.,'Air fares')])[1]
    set test variable       ${txtConfirmacion}
